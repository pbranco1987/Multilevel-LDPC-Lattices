...
VNR_dB         =  [0   0.2   0.4  0.5  0.6  0.7   0.8  0.884  0.9   1    1.05  1.2  1.3  1.4   1.5];
MaxFrameErrors =  [500 500   500  500  500  500   500  300    200   100  100   100  100  200   100];
VNR = 10.^(VNR_dB/10);
sigma = sqrt((2^(4-2*R))./(2*pi*exp(1).*VNR));

% triangular PEG and triangular check splitting with g=22
g = 22;
...
save('results_ldpc_cs_C0.mat','VNR_dB','ser','fer');
