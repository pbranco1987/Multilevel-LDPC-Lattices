...
VNR_dB         = [0      0.5    1.0    1.5   1.7   1.9  2.1  2.3  2.5  2.7  3.0];    
disp(VNR_dB);
MaxFrameErrors = [10000  10000  10000  2000  1000  500  200  200  200  100  50 ];
disp(MaxFrameErrors);
VNR = 10.^(VNR_dB/10);
...
save('results_ldpc_cs_C1.mat','fer','ser','VNR_dB');
